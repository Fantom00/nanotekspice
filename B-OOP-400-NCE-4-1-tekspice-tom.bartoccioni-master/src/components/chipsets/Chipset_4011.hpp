...
#ifndef CHIPSET_4011_HPP_
#define CHIPSET_4011_HPP_

#include "include_chipsets.hpp"
#include "pins/Pin_nand.hpp"
#include "pins/Pin_classique.hpp"
#include "pins/include_pins.h"

namespace nts
{
    class Chipset_4011 : public IComponent{
        public:
            Chipset_4011(const std::string &name);
            ~Chipset_4011();
