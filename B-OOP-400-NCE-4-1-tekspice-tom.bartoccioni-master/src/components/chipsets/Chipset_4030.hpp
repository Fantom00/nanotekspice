...
#ifndef CHIPSET_4030_HPP_
#define CHIPSET_4030_HPP_

#include "include_chipsets.hpp"
#include "pins/Pin_xor.hpp"
#include "pins/Pin_classique.hpp"
#include "pins/include_pins.h"

namespace nts
{
    class Chipset_4030 : public IComponent{
        public:
            Chipset_4030(const std::string &name);
            ~Chipset_4030();
