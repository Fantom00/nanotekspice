...
#ifndef CHIPSET_4081_HPP_
#define CHIPSET_4081_HPP_

#include "include_chipsets.hpp"
#include "pins/Pin_and.hpp"
#include "pins/Pin_classique.hpp"
#include "pins/include_pins.h"

namespace nts
{
    class Chipset_4081 : public IComponent{
        public:
            Chipset_4081(const std::string &name);
            ~Chipset_4081();
